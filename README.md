...
### Steps to flash factory image
 1. Download the KITKAT factory image fastboot package for YU YUREKA from [Here](https://cyngn.com/support/)

 2. Extract the contents of the fastboot package into a folder.

 3. Download this flashing tools package from [here](https://github.com/YUPlayGod/factory-image-flash-tools/archive/yureka-kitkat-windows-flashtools.zip)
